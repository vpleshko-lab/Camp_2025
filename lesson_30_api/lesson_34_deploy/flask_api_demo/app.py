...
@app.get("/customer")
def get_customers():
    return {cid: customer.model_dump() for cid, customer in CUSTOMERS.items()}

@app.get("/customer/<customer_id>")
def get_customer(customer_id):
    try:
        cid = int(customer_id)
        return CUSTOMERS[cid].model_dump()
    except ValueError:
...
# curl -X POST -F "image=@/home/x_lts/Downloads/horse.jpg" http://localhost:8000/ml/get_yolo_objects --output yolo_res.jpg
